      ...
      <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto ">
        ...
        <div className="max-w-xs">
          <div className="mt-1 relative p-3 rounded-md  ">
            ...
            <input
              className="bg-gray-100 block pl-10 sm:text-sm border-gray-300  focus:ring-black focus:border-black rounded-md "
              type="text"
              placeholder="Search"
            />
          </div>
        ...
        <div className="flex items-center justify-end space-x-4">
          ...
          {session ? (
            ...
            <>
              <button className="sm:text-sm text-xs  " onClick={signIn}>
                Sign In
              </button>
            </>
          )}
